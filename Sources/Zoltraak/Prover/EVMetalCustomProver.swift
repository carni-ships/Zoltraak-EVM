...
/// Zoltraak GPU Prover with custom commitment that matches zkMetal's position scheme.
///
...
public final class ZoltraakCustomProver {
    ...
    private static let threadLocalBufferKey = "ZoltraakCustomProver.threadLocalBuffer"
    ...
    public init(config: Config = .standard) {
        ...
        do {
            ...
            print("ZoltraakLeafHashEngine failed: \(error)")
