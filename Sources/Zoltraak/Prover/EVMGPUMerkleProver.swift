...
/// GPU-accelerated batch Merkle tree builder using Poseidon2-M31 via zkMetal
    ...
    /// Compile leaf hash shaders from Zoltraak's shader directory.
    ...
    private static func findShaderDir() -> String {
        ...
        let candidates = [
            "\(execDir)/../Sources/Zoltraak/Shaders",
            execDir + "/../Sources/Zoltraak/Shaders",
            "./Sources/Zoltraak/Shaders",
        ]
        ...
        return execDir + "/../Sources/Zoltraak/Shaders"
    }
...
public final class HierarchicalMerkleEngine {
    ...
    private static func findShaderDir() -> String {
        ...
        let candidates = [
            "\(execPath)/../Sources/Zoltraak/Shaders",
            execDir + "/../Sources/Zoltraak/Shaders",
            "./Sources/Zoltraak/Shaders",
        ]
        for path in candidates {
