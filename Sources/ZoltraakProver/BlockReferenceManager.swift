...
public struct BlockReferenceManager {
    ...
    private static func saveBlockToFile(block: EthereumBlock) throws -> String {
        ...
        let savePath = "/Users/carnation/Documents/Claude/Zoltraak/References/\(fileName)"

        // Ensure directory exists
        let dirPath = "/Users/carnation/Documents/Claude/Zoltraak/References"
...
"""
    ...
    private static func printBlockSummary(block: EthereumBlock) {
        ...
        print("Usage:")
        print("  swift run ZoltraakRunner reference-block    # Benchmark against reference block")
        print("")
