...
/// Run with: ./ZoltraakRunner benchmarks
///
...
public struct Profiler {
    public static func runProfile(txCount: Int = 10) {
        print("╔══════════════════════════════════════════════════════════════╗")
        print("║       Zoltraak Prover Phase Profiler (GPU-Optimized)          ║")
        print("╚══════════════════════════════════════════════════════════════╝")
        print("Workload: \(txCount) transactions")
        print("")
        print("NOTE: Run './ZoltraakRunner benchmarks' for full GPU benchmarks")
        print("")
        ...
        print("  • GPU Leaf Hash: OPTIMIZED (ZoltraakLeafHashEngine + H4 precomputation)")
