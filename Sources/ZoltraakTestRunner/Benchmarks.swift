...
/// Comprehensive benchmarking suite for Zoltraak prover components.
///
...
///
/// Run with: `swift run ZoltraakTestRunner --benchmark`
public struct Benchmarks {
    ...
    public static func runAll() {
        print("""
        ═══════════════════════════════════════════════════════════
        ║           Zoltraak Prover Benchmark Suite                 ║
        ═══════════════════════════════════════════════════════════
        """)
    ...
    /// Benchmarks EVMAIR trace commitment using ZoltraakGPUProver.
    ///
