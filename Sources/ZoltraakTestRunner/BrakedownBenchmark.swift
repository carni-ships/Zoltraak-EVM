...
/// Benchmark suite for Zoltraak Brakedown commitment.
///
...
///
/// Run with: `swift run ZoltraakTestRunner --brakedown-benchmark`
public struct BrakedownBenchmark {
    ...
    public static func runAll() {
        print("""
        ═══════════════════════════════════════════════════════════
        ║        Zoltraak Brakedown Commitment Benchmark           ║
        ═══════════════════════════════════════════════════════════
        """)
    ...
    public static func benchmarkBasicCommit() {
        ...
        for config in configs {
            do {
                let engine = try ZoltraakBrakedownEngine(config: .fast)
    ...
    public static func benchmarkEVMScale() {
        ...
        for config in configs {
            do {
                let engine = try ZoltraakBrakedownEngine(config: .standard)
