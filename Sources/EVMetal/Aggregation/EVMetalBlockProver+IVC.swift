// EVMetalBlockProver+IVC -- Integration of IVC with block prover
//
...
public final class EVMetalIVCBlockProver: Sendable {

    private let blockProver: EVMetalBlockProver
    ...
    public init(
        ...
        self.blockProver = try EVMetalBlockProver(config: blockConfig)
        self.ivcConfig = ivcConfig
