...
///
/// ```swift
/// let prover = try EVMetalMultiStreamProver()
...
/// ```
public final class EVMetalMultiStreamProver: Sendable {
    ...
    public init(config: Config = .default) throws {
        ...
        print("""
        ╔══════════════════════════════════════════════════════════════════╗
        ║           EVMetal Multi-Stream GPU Prover                        ║
        ╚══════════════════════════════════════════════════════════════════╝
        """)
    ...
    public func getMetricsReport() -> String {
        return """
        ============================================================
                   EVMetal Multi-Stream Prover Metrics
        ============================================================
