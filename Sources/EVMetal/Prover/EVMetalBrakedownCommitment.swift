...
public struct EVMetalBrakedownConfig {
    ...
    public static let fast = EVMetalBrakedownConfig(
...
public struct EVMetalBrakedownCommitResult {
...
public struct EVMetalBrakedownOpenResult {
    /// Batch opening proof.
...
/// EVMetal Brakedown Commitment Engine
///
...
///
/// ```swift
/// let engine = try EVMetalBrakedownEngine()
...
public class EVMetalBrakedownEngine {

    // MARK: - Properties

    /// Configuration
    public let config: EVMetalBrakedownConfig
    ...
    public init(config: EVMetalBrakedownConfig = .standard) throws {
        self.config = config
    ...
    /// - Returns: `EVMetalBrakedownCommitResult` with commitments and timing.
    public func commit(traceLDEs: [[M31]], evalLen: Int) throws -> EVMetalBrakedownCommitResult {
        ...
        return EVMetalBrakedownCommitResult(
    ...
    public func open(commitResult: EVMetalBrakedownCommitResult,
                     point: [Fr]) throws -> EVMetalBrakedownOpenResult {
        let t0 = CFAbsoluteTimeGetCurrent()
        ...
        return EVMetalBrakedownOpenResult(
    ...
    public func verify(commitResult: EVMetalBrakedownCommitResult,
                       openResult: EVMetalBrakedownOpenResult) -> Bool {
...
public struct EVMetalBrakedownInterleavedResult {
...
extension EVMetalBrakedownEngine {
    ...
    /// - Returns: `EVMetalBrakedownInterleavedResult` with 8 commitments and timing.
    public func commitInterleaved8Trees(
        traceLDEs: [[M31]],
        evalLen: Int
    ) throws -> EVMetalBrakedownInterleavedResult {
        let t0 = CFAbsoluteTimeGetCurrent()
        let numColumns = traceLDEs.count
        ...
        return EVMetalBrakedownInterleavedResult(
